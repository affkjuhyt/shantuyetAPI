    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('wait_owner_agree', 'Wait owner to agree'), ('wait_government_agree', 'Wait government to agree'), ('approved', 'Approved'), ('reject', 'Reject')], default='wait_owner_agree', max_length=40)),
                ...
                ('tea', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tea', to='teas.Teas')),
            ],
            options={
                'abstract': False,
            },
