    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('have_secondary_owner', 'Have secondary owner'), ('no_secondary_owner', 'No secondary owner'), ('transfer_in_progress', 'Transfer in progress')], default='no_secondary_owner', max_length=20)),
